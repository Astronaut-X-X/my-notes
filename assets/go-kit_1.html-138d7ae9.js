import{_ as s,M as r,p as l,q as t,R as e,t as n,N as a,a1 as d}from"./framework-efe98465.js";const c={},u=e("h1",{id:"micro-server",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#micro-server","aria-hidden":"true"},"#"),n(" Micro Server")],-1),v=e("p",null,[n("此文为 go-kit 的 stringsvc1 例子"),e("br"),n(" 此文主要写了如何使用 go-kit 创建一个简单的基于 http 协议的 RPC 服务"),e("br"),n(" 文中有表述不当的地方，可以通过 issue 请指出，谢谢阅读")],-1),o={href:"https://gokit.io/examples/stringsvc.html#stringsvc1",target:"_blank",rel:"noopener noreferrer"},p=d(`<p>流程步骤：</p><blockquote><p>1、定义服务</p></blockquote><div class="language-golang line-numbers-mode" data-ext="golang"><pre class="language-golang"><code>// 定义提供的服务
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18);function m(b,g){const i=r("ExternalLinkIcon");return l(),t("div",null,[u,v,e("p",null,[e("a",o,[n("stringsvc1"),a(i)])]),p])}const h=s(c,[["render",m],["__file","go-kit_1.html.vue"]]);export{h as default};
